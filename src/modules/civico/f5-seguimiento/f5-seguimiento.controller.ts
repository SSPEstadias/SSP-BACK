      ...
      examples: {
        ...
        'Escenario 2 — Sesión de seguimiento (progreso satisfactorio)': {
          ...
          value: {
            ...
            psicologoId: 2,
            numSesion: 3,
            fechaSesion: '2025-04-21',
            horaSesion: '10:00',
            fechaProximaSesion: '2025-04-28',
    ...
    @ApiResponse({
      ...
      schema: {
        ...
        properties: {
          ...
          fechaSesion: { type: 'string', format: 'date', example: '2025-04-07' },
